...
ContentMenu {
    ...
    ContentCard {
        ContentRowCard {
            ...
            StyledText {
                text: Bluetooth.bootstrapping ? "Power: Starting..." : (powerSwitch.checked ? "Power: On" : "Power: Off")
            ...
            StyledSwitch {
                ...
                enabled: !Bluetooth.bootstrapping
        ...
        ContentRowCard {
            ...
            StyledText {
                text: Bluetooth.bootstrapping
                    ? "Trying to start bluetooth.service and power on adapter..."
                    : "No Bluetooth adapter detected. Toggle Power to auto-start bluetooth.service."
